...
import { Anchor, Mail, Lock, User, ArrowRight } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-blue-950 to-slate-950 text-white flex items-center justify-center px-4 py-8">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="p-8 rounded-2xl bg-blue-950/40 border border-blue-800/30 backdrop-blur">
          <h1 className="text-3xl font-bold mb-2 text-center">Добро пожаловать на борт!</h1>
          <p className="text-blue-200/70 text-center mb-8">Создай аккаунт за 30 секунд</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm text-blue-200 mb-2">Имя</label>
            ...
            <div className="p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/30">
              <p className="text-sm text-cyan-200">
                🎁 <strong>7 дней бесплатно</strong> — без привязки карты
              </p>
            </div>
